 ...
 */
final class Version20240706223101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE position ADD COLUMN cible VARCHAR(255) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__position AS SELECT id, alliance_id, serveur_id, pos_x, pos_y FROM position');
        ...
        $this->addSql('INSERT INTO position (id, alliance_id, serveur_id, pos_x, pos_y) SELECT id, alliance_id, serveur_id, pos_x, pos_y FROM __temp__position');
